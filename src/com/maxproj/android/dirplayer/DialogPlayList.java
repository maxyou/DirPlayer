...
public class DialogPlayList extends DialogFragment {
	...
	public static DialogPlayList newInstance(File f) {
		DialogPlayList dialogFragment = new DialogPlayList();
		dialogFragment.mf = f;
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
	    ...
	    final View v = inflater.inflate(R.layout.playlist_cmd, null);
