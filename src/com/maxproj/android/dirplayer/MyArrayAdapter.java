...
public class MyArrayAdapter extends ArrayAdapter{
    ...
    public MyArrayAdapter(Context context, int textViewResourceId, List<LvRow> objects) {
        ...
        listItems = objects;
        Log.d(DTAG,"initialize MyArrayAdapter...end");
    }
    ...
    public View getView (int position, View convertView, ViewGroup parent){
        ...
        Log.d(DTAG, "getView: name: " + name.getText());
        ...
        if (fileName.equals("/..")) // can't choose parent directory
        {
            ...
            Log.d(DTAG,"getView: " + lr.getName());
        }else{
            cb.setVisibility(cb.VISIBLE);
            cb.setChecked(listItems.get(position).getSelected()); // restore check state
            Log.d(DTAG,"getView: listItems "+ position +" is "+ listItems.get(position).getSelected());
            ...
            cb.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Log.d(DTAG, "getView: listItems getTag " + (Integer)view.getTag() + " set " + cb.isChecked());
